      ...
      <div className="max-w-content mx-auto px-6 lg:px-12 py-14 grid gap-10 md:grid-cols-4 text-[14px]">
        <div>
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="font-semibold tracking-[-0.016em] text-ink">Provenance</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-ink">
            ...
            <li><Link href="#provenance" className="hover:text-graphite">How they&rsquo;re built</Link></li>
