...
We pick channels by where Mira and Alex already are. The ranking below is by expected first-90-day yield, not by how scalable each channel will be at year-two.

## Channel mix

| Rank | Channel | Why it fits |
|------|---------|-------------|
| 1 | **Peer Slack DMs (warm intros)** | Mira gets her best signal from peers; we ship a 2-line referral copy block per agent. |
...
The buyer cohort is small (sub-1,000 named operators in our wedge), trust-driven, and fatigued by category-level "AI marketplace" noise. We win by being the catalog that shows up in their peer DMs, not the brand they Google.

## What we explicitly do **not** do

- Cold display advertising.
- Sponsoring a generic AI conference where everyone has a robot mascot.
- LinkedIn organic from a "thought leader" account. Mira already mutes those.
- A first-touch email that contains the word "leverage."
